    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading custompanel">
                ...
                <c:if test="${request.status != 3 && request.status != 5 && request.status != 6}">
                    <c:if test="${id == request.createdBy}">
                        ...
                        <button type="button" class="btn btn-default custom" id="priority-change" name="priority-btn" data-toggle="modal" data-target="#priorityModal">
                            <span class="glyphicon glyphicon-pencil"></span>Thay đổi mức độ ưu tiên
                        </button>
                        <!-- Department Modal -->
                ...
                <div class="col-xs-12">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h3 class="media-heading" style="margin-left: 100px;">${request.createdByName}
                                </br>
